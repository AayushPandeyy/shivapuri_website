  ...
  return (
    <section>
      ...
      >
        ...
        <div className="contactDetails lg:w-[50%] w-full p-8 relative z-20 text-black">
          <div className="items flex flex-col w-[90%] mx-auto">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4 bg-gradient-to-l from-blue-400 to-[#0056A7] text-white rounded-lg p-4">
        ...
        {/* Google Map */}
        <div className="w-full lg:w-[50%] relative z-20 p-3">
          <iframe
          ...
          <form className="p-6">
            <div className="mb-6">
              <input
                ...
                className="w-full px-4 py-2 h-12 rounded-lg bg-gray-200 text-black placeholder-black focus:ring-2 focus:ring-[#0056A7] outline-none transition duration-200"
              />
            </div>
            <div className="mb-6">
              <input
            ...
            <div className="mb-6">
              <textarea
                ...
                className="w-full px-4 py-2 h-32 rounded-lg bg-gray-200 text-black placeholder-black focus:ring-2 focus:ring-[#0056A7] outline-none transition duration-200"
              />
            </div>
            <button
              type="submit"
